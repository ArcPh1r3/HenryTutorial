...
namespace HenryMod.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => HenryPlugin.DEV_PREFIX + "_HENRY_BODY_MASTERY";
        public override string AchievementSpriteName => "texMasteryAchievement";
        public override string PrerequisiteUnlockableIdentifier => HenryPlugin.DEV_PREFIX + "_HENRY_BODY_UNLOCKABLE_REWARD_ID";
