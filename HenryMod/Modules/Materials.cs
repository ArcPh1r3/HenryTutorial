...
namespace HenryMod.Modules {
    internal static class Materials {
        ...
        private static Material CreateHopooMaterial(Material tempMat) {
        ...
        public static Material SetHopooMaterial(this Material tempMat) {
            ...
            //set this keyword in unity if you've set up your model's vertex colors for limb removal item displays
