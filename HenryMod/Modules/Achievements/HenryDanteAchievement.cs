...
namespace HenryMod.Modules.Achievements
{
    ...
    public class DanteAchievement : ModdedUnlockableAndAchievement<CustomSpriteProvider>
    {
        ...
        protected override CustomSpriteProvider SpriteProvider { get; } = new CustomSpriteProvider("@Henry:Assets/HenryAssets/Icons/texDanteAchievement.png");
